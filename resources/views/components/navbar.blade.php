<div class="sticky-top bg-black">
  ...
  <header class="border-bottom py-3 text-center d-flex justify-content-between align-items-center">
    ...
    <a href="{{ route('bulletin') }}" class="d-lg-flex justify-content-center flex-grow-1">
      <img class="blog-header-logo text-body-emphasis text-decoration-none" style="max-height: 65px; margin: 0 auto;" src="https://res.cloudinary.com/de6hiq5n4/image/upload/v1724211597/affix/assets/q408afy53m8azge4fahb.png" alt="AFFIX">
    </a>
  </header>
